                    ...
                    <div class="row">
                            ...
                            <div class="row">           
                                ...
                                <fieldset>
									...
									<c:if test="${actionBean.myquestions.size() > 0 }">
		                                <c:forEach var="message" items="${actionBean.myquestions}">
                        ...
                        <div class="small-4 columns sidebar" style="min-height: 500px">
                            ...
                            <ul class="side-nav">
                                ...
                                <li   class="active"><a href="/SpreadTheLove/questioniasked.action"><i class="fa fa-lightbulb-o fa-fw" ></i> Questions I asked</a></li>
