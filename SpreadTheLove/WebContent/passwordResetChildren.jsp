        ...
        <script>
            $(document).ready(function(){
                ...
                $('button').click(function(){       
                    alert("Your password is frenchfries");
                });            
            });
        </script>
			<!--[if IE]>
...
<body>
    ...
    <div class="row">
        <div class="large-6 columns">
            <label>Security Question
                <select>
                  <option value="husker">What was your childhood nickname?</option>
                  <option value="starbuck">What is the name of your favorite childhood friend?</option>
                  <option value="hotdog">What was the name of your first stuffed animal?</option>
                  <option value="apollo">What is your mother's maiden name</option>
                </select>
            </label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="large-6 columns">
        <label>Answer
            <input id="ansInput" type="text" placeholder="Enter your answer here" />
        </label>
        </div>
    </div>
    <div class="row">
